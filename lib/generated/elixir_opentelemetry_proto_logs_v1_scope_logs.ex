...
defmodule Opentelemetry.Proto.Logs.V1.ScopeLogs do
  @moduledoc false
  defstruct scope: nil, log_records: [], schema_url: "", __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_log_records(acc, msg) do
        try do
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Opentelemetry.Proto.Logs.V1.ScopeLogs))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 log_records:
                   msg.log_records ++ [Opentelemetry.Proto.Logs.V1.LogRecord.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:log_records, :unpacked, {:message, Opentelemetry.Proto.Logs.V1.LogRecord}},
    ...
    def defs_by_name() do
      %{
        log_records: {2, :unpacked, {:message, Opentelemetry.Proto.Logs.V1.LogRecord}},
        schema_url: {3, {:scalar, ""}, :string},
        scope: {1, {:scalar, nil}, {:message, Opentelemetry.Proto.Common.V1.InstrumentationScope}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :log_records,
          tag: 2,
          type: {:message, Opentelemetry.Proto.Logs.V1.LogRecord}
        },
        %{
          __struct__: Protox.Field,
          json_name: "schemaUrl",
