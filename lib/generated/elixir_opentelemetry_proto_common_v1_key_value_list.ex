...
defmodule Opentelemetry.Proto.Common.V1.KeyValueList do
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[
                 values: msg.values ++ [Opentelemetry.Proto.Common.V1.KeyValue.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{1 => {:values, :unpacked, {:message, Opentelemetry.Proto.Common.V1.KeyValue}}}
    end
    ...
    def defs_by_name() do
      %{values: {1, :unpacked, {:message, Opentelemetry.Proto.Common.V1.KeyValue}}}
    end
  )
