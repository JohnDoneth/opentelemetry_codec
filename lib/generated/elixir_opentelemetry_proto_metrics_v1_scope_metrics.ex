...
defmodule Opentelemetry.Proto.Metrics.V1.ScopeMetrics do
  @moduledoc false
  defstruct scope: nil, metrics: [], schema_url: "", __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_metrics(acc, msg) do
        try do
          case msg.metrics do
            [] ->
              acc
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Opentelemetry.Proto.Metrics.V1.ScopeMetrics))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 metrics:
                   msg.metrics ++ [Opentelemetry.Proto.Metrics.V1.Metric.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:metrics, :unpacked, {:message, Opentelemetry.Proto.Metrics.V1.Metric}},
    ...
    def defs_by_name() do
      %{
        metrics: {2, :unpacked, {:message, Opentelemetry.Proto.Metrics.V1.Metric}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :metrics,
          tag: 2,
          type: {:message, Opentelemetry.Proto.Metrics.V1.Metric}
        },
        %{
          __struct__: Protox.Field,
          json_name: "schemaUrl",
