  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Opentelemetry.Proto.Metrics.V1.NumberDataPoint))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        4 => {:as_double, {:oneof, :value}, :double},
        5 => {:exemplars, :unpacked, {:message, Opentelemetry.Proto.Metrics.V1.Exemplar}},
    ...
    def defs_by_name() do
      %{
        as_double: {4, {:oneof, :value}, :double},
        as_int: {6, {:oneof, :value}, :sfixed64},
        attributes: {7, :unpacked, {:message, Opentelemetry.Proto.Common.V1.KeyValue}},
        exemplars: {5, :unpacked, {:message, Opentelemetry.Proto.Metrics.V1.Exemplar}},
