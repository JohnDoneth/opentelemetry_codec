...
defmodule Opentelemetry.Proto.Metrics.V1.Summary do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_data_points(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Opentelemetry.Proto.Metrics.V1.Summary))
        end
      )
    )
          ...
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[
                 data_points:
                   msg.data_points ++
                     [Opentelemetry.Proto.Metrics.V1.SummaryDataPoint.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        1 =>
          {:data_points, :unpacked, {:message, Opentelemetry.Proto.Metrics.V1.SummaryDataPoint}}
      }
    end
    ...
    def defs_by_name() do
      %{data_points: {1, :unpacked, {:message, Opentelemetry.Proto.Metrics.V1.SummaryDataPoint}}}
    end
  )
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :data_points,
          tag: 1,
          type: {:message, Opentelemetry.Proto.Metrics.V1.SummaryDataPoint}
        }
      ]
    end
