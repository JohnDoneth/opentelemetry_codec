...
defmodule Opentelemetry.Proto.Common.V1.ArrayValue do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_values(msg) |> encode_unknown_fields(msg)
      end
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[
                 values: msg.values ++ [Opentelemetry.Proto.Common.V1.AnyValue.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{1 => {:values, :unpacked, {:message, Opentelemetry.Proto.Common.V1.AnyValue}}}
    end
    ...
    def defs_by_name() do
      %{values: {1, :unpacked, {:message, Opentelemetry.Proto.Common.V1.AnyValue}}}
    end
  )
