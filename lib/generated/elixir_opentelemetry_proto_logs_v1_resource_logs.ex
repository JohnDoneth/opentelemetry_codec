...
defmodule Opentelemetry.Proto.Logs.V1.ResourceLogs do
  @moduledoc false
  defstruct resource: nil, scope_logs: [], schema_url: "", __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_scope_logs(acc, msg) do
        try do
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Opentelemetry.Proto.Logs.V1.ResourceLogs))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 scope_logs:
                   msg.scope_logs ++ [Opentelemetry.Proto.Logs.V1.ScopeLogs.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:scope_logs, :unpacked, {:message, Opentelemetry.Proto.Logs.V1.ScopeLogs}},
    ...
    def defs_by_name() do
      %{
        ...
        scope_logs: {2, :unpacked, {:message, Opentelemetry.Proto.Logs.V1.ScopeLogs}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :scope_logs,
          tag: 2,
          type: {:message, Opentelemetry.Proto.Logs.V1.ScopeLogs}
        },
        %{
          __struct__: Protox.Field,
          json_name: "schemaUrl",
