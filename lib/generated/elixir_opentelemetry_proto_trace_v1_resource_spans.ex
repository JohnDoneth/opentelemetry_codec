...
defmodule Opentelemetry.Proto.Trace.V1.ResourceSpans do
  @moduledoc false
  defstruct resource: nil, scope_spans: [], schema_url: "", __uf__: []
    ...
    [
      ...
      defp encode_scope_spans(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:scope_spans, "invalid field value"), __STACKTRACE__
        end
      end,
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 scope_spans:
                   msg.scope_spans ++ [Opentelemetry.Proto.Trace.V1.ScopeSpans.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:scope_spans, :unpacked, {:message, Opentelemetry.Proto.Trace.V1.ScopeSpans}},
    ...
    def defs_by_name() do
      %{
        ...
        scope_spans: {2, :unpacked, {:message, Opentelemetry.Proto.Trace.V1.ScopeSpans}}
      }
    end
  )
