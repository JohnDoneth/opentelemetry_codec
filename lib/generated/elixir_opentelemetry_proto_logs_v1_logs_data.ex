...
defmodule Opentelemetry.Proto.Logs.V1.LogsData do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_resource_logs(msg) |> encode_unknown_fields(msg)
      end
    )
    ...
    [
      defp encode_resource_logs(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:resource_logs, "invalid field value"),
                    __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Opentelemetry.Proto.Logs.V1.LogsData))
        end
      )
    )
          ...
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[
                 resource_logs:
                   msg.resource_logs ++
                     [Opentelemetry.Proto.Logs.V1.ResourceLogs.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{1 => {:resource_logs, :unpacked, {:message, Opentelemetry.Proto.Logs.V1.ResourceLogs}}}
    end
    ...
    def defs_by_name() do
      %{resource_logs: {1, :unpacked, {:message, Opentelemetry.Proto.Logs.V1.ResourceLogs}}}
    end
  )
  ...
  (
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :resource_logs,
          tag: 1,
          type: {:message, Opentelemetry.Proto.Logs.V1.ResourceLogs}
        }
      ]
    end
    ...
    [
      ...
      (
        def field_def(:resource_logs) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "resourceLogs",
