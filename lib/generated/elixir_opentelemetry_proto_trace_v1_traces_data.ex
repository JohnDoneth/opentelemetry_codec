...
defmodule Opentelemetry.Proto.Trace.V1.TracesData do
  @moduledoc false
  defstruct resource_spans: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_resource_spans(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    ...
    def defs() do
      %{1 => {:resource_spans, :unpacked, {:message, Opentelemetry.Proto.Trace.V1.ResourceSpans}}}
    end
    ...
    def defs_by_name() do
      %{resource_spans: {1, :unpacked, {:message, Opentelemetry.Proto.Trace.V1.ResourceSpans}}}
    end
  )
