...
defmodule Opentelemetry.Proto.Metrics.V1.MetricsData do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_resource_metrics(msg) |> encode_unknown_fields(msg)
      end
    )
    ...
    [
      defp encode_resource_metrics(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:resource_metrics, "invalid field value"),
                    __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Opentelemetry.Proto.Metrics.V1.MetricsData))
        end
      )
    )
              ...
              {[
                 resource_metrics:
                   msg.resource_metrics ++
                     [Opentelemetry.Proto.Metrics.V1.ResourceMetrics.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs_by_name() do
      %{
        resource_metrics:
          {1, :unpacked, {:message, Opentelemetry.Proto.Metrics.V1.ResourceMetrics}}
      }
    end
  )
  ...
  (
    ...
    def fields_defs() do
      [
        %{
          ...
          tag: 1,
          type: {:message, Opentelemetry.Proto.Metrics.V1.ResourceMetrics}
        }
      ]
    end
    ...
    [
      ...
      (
        def field_def(:resource_metrics) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "resourceMetrics",
        ...
        def field_def("resourceMetrics") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "resourceMetrics",
